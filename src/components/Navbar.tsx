...
function Navbar({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "absolute top-full left-0 w-full lg:static lg:w-auto lg:flex lg:space-x-8 bg-white lg:bg-transparent shadow-lg lg:shadow-none",
